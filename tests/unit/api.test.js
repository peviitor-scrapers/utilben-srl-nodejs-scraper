...
describe('scraper/api.js', () => {
  ...
  describe('querySOLR', () => {
    ...
    it('should throw on HTTP error', async () => {
      ...
      await expect(solr.querySOLR('18643343')).rejects.toThrow('API jobs query error: 500');
    });
  });
  ...
  describe('deleteJobsByCIF', () => {
    ...
    it('should throw on HTTP error', async () => {
      ...
      await expect(solr.deleteJobsByCIF('18643343')).rejects.toThrow('API jobs delete error: 500');
    });
  });
