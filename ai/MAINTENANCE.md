...
```bash
gh issue list --repo peviitor-scrapers/utilben-srl-nodejs-scraper --state open
```
...
- `docs/test-results/index.html` — branding must say "UTILBEN SRL", not the old template
